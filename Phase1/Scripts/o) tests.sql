...
begin
	...
	begin
    	resultado := false;
    	perform criarJogador('jogador7@gmail.com', 'jogador8', 1);
  	exception
    	when others then
      		select not exists (
				select 1 
				from jogador 
				where email = 'jogador7@gmail.com' and username = 'jogador8' and regiao_id = 1
			) into resultado;
  	end;
  	...
  	begin
    	resultado := false;
    	perform criarJogador('jogador8@gmail.com', 'jogador7', 1);
  	exception
    	when others then
      		select not exists (
				select 1 
				from jogador 
				where email = 'jogador8@gmail.com' and username = 'jogador7' and regiao_id = 1
			) into resultado;
  	end;
  	...
  	exception
    	when others then
      		select not exists (
				select 1 
				from jogador 
				where email = 'jogador7@gmail.com' and username = 'jogador7' and regiao_id = 4
			) into resultado;
  	end;
	...
	for each row execute function simular_erro_insercao();
  	...
  	delete from conversa where nome = 'conversa4' and id = v_output;
...
delete from jogador where email = 'jogador7@gmail.com' and username = 'jogador7' and regiao_id = 1;
update jogador set estado = 'Ativo' where id = 6;
delete from mensagem where jogador_id = 4 and conversa_id = 1 and texto = 'hahaa';
delete from participacao_conversa where jogador_id = 1 and conversa_id = 1;
update partida set data_fim = null where id = 1;
update jogador set estado = 'Ativo' where id = 1;
drop function if exists teste(integer, varchar(255), boolean);
